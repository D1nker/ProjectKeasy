...
include ('app/model/logement/edit_logement.php');
$acceptedTypes = [
    "image/jpeg",
    "image/png",
    "application/pdf",
...
if (isset($_GET['id'])) {
$options = array("wherecolumn" => "logement_id", "wherevalue" => $_GET['id']);
...
define("BODY_CLASS", "edit_logement");
define("PAGE_TITLE", "Modifier un logement publié, Keasy");
include_once("app/view/logement/edit_logement.php");