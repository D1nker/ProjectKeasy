...

   {
        ...
        try {
           ...
           $req = "UPDATE  user
                    ...
                    token= :token, school_school_id= :school, cat_user_id= :cat_user
                   WHERE user_id= :self";
            ...
            $query->bindParam(':token', $users["token"], PDO::PARAM_STR);
            $query->bindParam(':school', $users["school"], PDO::PARAM_STR);
            $query->bindParam(':cat_user', $users["cat_user"], PDO::PARAM_STR);
