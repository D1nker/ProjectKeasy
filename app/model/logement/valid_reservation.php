...
try {
    ...
    $query = $pdo->prepare('SELECT logement_id, logement_name, logement_photo, logement_price, reservation_date_arrive, reservation_date_return,
                                   logement_user_id, user_id, user_firstname, cat_id, location_place_id, user_lastname, logement_cat_id, 
                                   logement_category_type, place_id, place_name, reservation_id, token_reservation
                                        FROM reservation
                                        INNER JOIN logement
